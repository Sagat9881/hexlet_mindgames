...
class CommandLineDrawerTest {
    ...
    getSimpleCommandLineObjectView(int x1, int x2, int y1, int y2, int layer, AnsiColors color) {
        CommandLineGameContext.CommandLineObjectView view =
                new CommandLineGameContext.CommandLineObjectView(color.colorCode, layer, x1, x2, y1, y2);
    ...
    @Test
    void drawFrame() {
        CommandLineGameContext.CommandLineObjectView blue = getSimpleCommandLineObjectView(0, 24, 0, 9, 1, AnsiColors.ANSI_BLUE);
        CommandLineGameContext.CommandLineObjectView green = getSimpleCommandLineObjectView(5, 7, 0, 9, 1, AnsiColors.ANSI_GREEN);

        CommandLineGameContext.CommandLineObjectView red = getSimpleCommandLineObjectView(0, 5, 3, 9, 2, AnsiColors.ANSI_RED);
        CommandLineGameContext.CommandLineObjectView cyan = getSimpleCommandLineObjectView(7, 9, 3, 9, 2, AnsiColors.ANSI_WHITE);

        CommandLineGameContext.CommandLineObjectView yellow = getSimpleCommandLineObjectView(0, 6, 6, 9, 3, AnsiColors.ANSI_YELLOW);
        CommandLineGameContext.CommandLineObjectView purple = getSimpleCommandLineObjectView(9, 24, 0, 9, 3, AnsiColors.ANSI_PURPLE);
